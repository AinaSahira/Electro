package com.androidproject.Electro;
...
import com.androidproject.Electro.databinding.ActivityAboutBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.toolbar.shareIconIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String shareText = "https://github.com/AinaSahira/Electro";
        ...
        binding.linkToGitHubTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String githubUrl = "https://github.com/AinaSahira/Electro";
